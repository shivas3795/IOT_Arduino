...
boolean trigger=false; //stores if first trigger (lower threshold) has occurred

byte triggercount=0; //stores the counts past since trigger 1 was set true
int buzz=11;
...
delay(500);
 ...
 Serial.println(AM);
    ...
    if (AM>20){ 
        fall=true; trigger=false; triggercount=0;
             }
